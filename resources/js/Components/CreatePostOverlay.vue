...
const getUploadedImage = (e) => {
    ...
    if (extention == "png" || extention == "jpg" || extension == "jpeg") {
...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="flex items-center bg-gray-100 w-full h-full overflow-auto"
                >
                    <div
                        v-if="!fileDisplay"
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    ...
                    <div class="text-gray-500 mt-3 p-3 text-sm">
                        Your rell will be shared with your followers in their
